...
public class PhoneFormatCheckUtils {
    ...
    private static final Pattern LANDLINE_PATTERN = Pattern.compile("[-)(0-9]{4,20}");
     ...
     * 0357-53608462
     */
    public static boolean isChinaLandLineLegal(String str) throws PatternSyntaxException {
        Matcher m = LANDLINE_PATTERN.matcher(str);
        return m.matches();
    }
